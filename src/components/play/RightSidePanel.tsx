      ...
      >
        ...
        <div style={{ 
          ...
          <AccordionSection
            title="パートナー"
            icon="👤"
            count={partnerZone.length > 0 ? partnerZone.length : undefined}
            defaultOpen={true}
            headerColor="#e91e63"
          >
            <div style={{
              ...
              {partnerZone.length > 0 && (
                <div>
                  ...
                  <div style={{
                    ...
                    {partnerZone.map((card, idx) => (
                      <div
                        key={`partner-zone-${card.id}-${idx}`}
                        onClick={() => onPartnerClick(card)}
                        style={{
                          width: `${CARD_WIDTH}px`,
                          aspectRatio: "0.7",
                          borderRadius: "4px",
